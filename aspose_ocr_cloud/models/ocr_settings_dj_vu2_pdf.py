...
class OCRSettingsDjVu2PDF(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["language", "Rotate", "makeSkewCorrect", "makeSpellCheck", "makeContrastCorrection", "makeBinarization", "makeUpsampling", "dsrMode", "dsrConfidence", "resultType", "resultTypeTable", "regions"]
