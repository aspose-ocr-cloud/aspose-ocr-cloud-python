...
class OCRResult(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="File data type (extension)")
    data: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="File binary data")
