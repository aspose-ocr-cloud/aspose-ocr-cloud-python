...
class OCRSettingsRecognizeFont(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["language", "makeSkewCorrect", "makeSpellCheck", "makeContrastCorrection", "resultType", "Rotate", "makeBinarization", "makeUpsampling", "dsrMode", "dsrConfidence", "resultTypeTable", "regions"]
