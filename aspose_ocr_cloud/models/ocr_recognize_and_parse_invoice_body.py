...
class OCRRecognizeAndParseInvoiceBody(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": obj.get("image"),
            "settings": OCRSettingsRecognizeAndParseInvoice.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
