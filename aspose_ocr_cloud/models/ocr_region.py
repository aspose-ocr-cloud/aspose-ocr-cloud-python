...
class OCRRegion(BaseModel):
    ...
    """ # noqa: E501
    rect: Optional[OCRRect] = None
    order: Optional[StrictInt] = Field(default=None, description="The serial number of the region for the formation of the text")
    __properties: ClassVar[List[str]] = ["rect", "order"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rect": OCRRect.from_dict(obj["rect"]) if obj.get("rect") is not None else None,
            "order": obj.get("order")
        })
        return _obj
