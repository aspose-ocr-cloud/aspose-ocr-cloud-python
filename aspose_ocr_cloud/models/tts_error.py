...
class TTSError(BaseModel):
    ...
    """ # noqa: E501
    messages: Optional[List[StrictStr]] = Field(default=None, description="A list of various clear descriptions of the errors")
    warnings: Optional[List[StrictStr]] = Field(default=None, description="Warning messages - non critical errors: e.g. some data lost")
