...
class TTSResponse(BaseModel):
    ...
    task_status: Optional[TTSTaskStatus] = Field(default=None, alias="taskStatus")
    results: Optional[List[TTSResult]] = Field(default=None, description="List of results - Especially Text or PDF files")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [TTSResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "error": TTSError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
