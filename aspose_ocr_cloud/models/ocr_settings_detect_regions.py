...
class OCRSettingsDetectRegions(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["makeSkewCorrect", "makeContrastCorrection", "makeUpsampling", "dsrConfidence", "language", "Rotate", "makeSpellCheck", "makeBinarization", "dsrMode", "resultType", "resultTypeTable", "regions"]
