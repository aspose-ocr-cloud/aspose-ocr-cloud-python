...
class OCRSettingsRecognizeAndParseInvoice(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["makeSkewCorrect", "makeBinarization", "makeUpsampling", "resultType", "language", "Rotate", "makeSpellCheck", "makeContrastCorrection", "dsrMode", "dsrConfidence", "resultTypeTable", "regions"]
