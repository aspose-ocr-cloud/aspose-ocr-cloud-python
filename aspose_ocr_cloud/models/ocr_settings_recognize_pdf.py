...
class OCRSettingsRecognizePdf(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["language", "makeSkewCorrect", "makeSpellCheck", "makeContrastCorrection", "dsrMode", "dsrConfidence", "resultType", "Rotate", "makeBinarization", "makeUpsampling", "resultTypeTable", "regions"]
