...
class OCRSettingsRecognizeReceipt(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["language", "makeSkewCorrect", "makeSpellCheck", "makeContrastCorrection", "Rotate", "makeBinarization", "makeUpsampling", "dsrMode", "dsrConfidence", "resultType", "resultTypeTable", "regions"]
