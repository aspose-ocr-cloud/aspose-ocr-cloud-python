...
class OCRRecognizeAndParseInvoiceBody(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def settings() -> typing.Type['OCRSettingsRecognizeAndParseInvoice']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["settings"]) -> 'OCRSettingsRecognizeAndParseInvoice': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["settings"]) -> 'OCRSettingsRecognizeAndParseInvoice': ...
