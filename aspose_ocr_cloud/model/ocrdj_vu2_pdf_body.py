...
class OCRDjVu2PDFBody(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def settings() -> typing.Type['OCRSettingsDjVu2PDF']:
                return OCRSettingsDjVu2PDF
            __annotations__ = {
                "image": image,
                "settings": settings,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["settings"]) -> 'OCRSettingsDjVu2PDF': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["settings"]) -> 'OCRSettingsDjVu2PDF': ...
