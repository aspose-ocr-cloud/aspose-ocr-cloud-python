...
class OCRSettingsRecognizeRegions(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["language"], typing_extensions.Literal["makeSkewCorrect"], typing_extensions.Literal["makeSpellCheck"], typing_extensions.Literal["makeContrastCorrection"], typing_extensions.Literal["makeUpsampling"], typing_extensions.Literal["regions"], typing_extensions.Literal["resultType"], typing_extensions.Literal["Rotate"], typing_extensions.Literal["makeBinarization"], typing_extensions.Literal["dsrMode"], typing_extensions.Literal["dsrConfidence"], typing_extensions.Literal["resultTypeTable"], ]):
