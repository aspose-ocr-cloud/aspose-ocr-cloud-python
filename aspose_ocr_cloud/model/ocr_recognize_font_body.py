...
class OCRRecognizeFontBody(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def settings() -> typing.Type['OCRSettingsRecognizeFont']:
                return OCRSettingsRecognizeFont
            __annotations__ = {
                "image": image,
                "settings": settings,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["settings"]) -> 'OCRSettingsRecognizeFont': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["settings"]) -> 'OCRSettingsRecognizeFont': ...
