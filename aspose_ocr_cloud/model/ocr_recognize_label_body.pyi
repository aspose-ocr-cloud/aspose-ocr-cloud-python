...
class OCRRecognizeLabelBody(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def settings() -> typing.Type['OCRSettingsRecognizeLabel']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["settings"]) -> 'OCRSettingsRecognizeLabel': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["settings"]) -> 'OCRSettingsRecognizeLabel': ...
