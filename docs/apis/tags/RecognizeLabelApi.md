<a name="__pageTop"></a>
# aspose_ocr_cloud.apis.tags.recognize_label_api.RecognizeLabelApi
...
from aspose_ocr_cloud.apis.tags import recognize_label_api
...
with aspose_ocr_cloud.ApiClient(configuration) as api_client:
    ...
    api_instance = recognize_label_api.RecognizeLabelApi(api_client)
    ...
    try:
        # CancelRecognizeLabel
        api_response = api_instance.cancel_recognize_label(
...
200 | [ApiResponseFor200](#cancel_recognize_label.ApiResponseFor200) | Success

#### cancel_recognize_label.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
with aspose_ocr_cloud.ApiClient(configuration) as api_client:
    ...
    try:
        # GetRecognizeLabel
        api_response = api_instance.get_recognize_label(
            query_params=query_params,
        )
        pprint(api_response)
    except aspose_ocr_cloud.ApiException as e:
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_recognize_label.ApiResponseFor200) | Success

#### get_recognize_label.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
...
with aspose_ocr_cloud.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    body = OCRRecognizeLabelBody(
        image='YQ==',
        settings=OCRSettingsRecognizeLabel(
    ...
    try:
        # PostRecognizeLabel
        api_response = api_instance.post_recognize_label(
            body=body,
        )
        pprint(api_response)
    except aspose_ocr_cloud.ApiException as e:
...
Type | Description  | Notes
------------- | ------------- | -------------
[**OCRRecognizeLabelBody**](../../models/OCRRecognizeLabelBody.md) |  | 
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#post_recognize_label.ApiResponseFor200) | Task unique ID
401 | [ApiResponseFor401](#post_recognize_label.ApiResponseFor401) | Unauthorized

#### post_recognize_label.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
...
#### post_recognize_label.ApiResponseFor401
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
