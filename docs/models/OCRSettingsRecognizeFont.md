# aspose_ocr_cloud.model.ocr_settings_recognize_font.OCRSettingsRecognizeFont
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | OCR Process setting for Font image recognition | 
